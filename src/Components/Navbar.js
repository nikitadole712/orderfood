...
export default function Navbar(props) {
  ...
  return (
    <div>
      <nav
        className="navbar navbar-expand-lg navbar-dark shadow-lg p-3 rounded position-sticky"
        style={{
      ...
      >
        <div className="container-fluid">
          ...
          <Link
            className="navbar-brand fs-1 fst-italic mx-2 text-black"
            to="#"
          >
            Taste4U
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav me-auto mb-2">
              <li className="nav-item">
                <Link
                  className="nav-link active fs-5 mx-2 text-black"
                  aria-current="page"
                  to="/"
                >
                  Home
              ...
              {localStorage.getItem('token') ? (
                <li className="nav-item">
                  <Link
                    className="nav-link fs-5 mx-3 active text-black"
                    aria-current="page"
                    to="/myorder"
                  >
                    My Orders
